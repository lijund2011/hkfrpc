...
---
## 简易使用方法
1. Linux   一键启动 / 3U8yX5zDrxE 为token码 FUYJQGTI为隧道名
```shell
/frpc -u 3U8yX5zDrxE -p FUYJQGTI
```          
2. Windows 一键启动 / 3U8yX5zDrxE 为token码 FUYJQGTI为隧道名
```shell
frpc.exe -u 3U8yX5zDrxE -p FUYJQGTI
```
